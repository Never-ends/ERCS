...
namespace ERCS.Controllers
{
    ...
    public partial class HospitalController : BaseController
    {
        ...
        [ActionDescription("搜索")]
        [HttpPost]
        public string Search(HospitalListVM vm)
        {
        ...
        {
            var vm = CreateVM<HospitalBatchVM>(Ids: IDs);
            return PartialView(vm);
        }
        ...
        public IActionResult ExportExcel(HospitalListVM vm)
        {
            ...
            return File(data, "application/vnd.ms-excel", $"Export_Hospital_{DateTime.Now.ToString("yyyy-MM-dd")}.xls");
        }
